...
const Constellations = () => {
  ...
  useEffect(() => {
    ...
    // Fix ESLint warning: async setState
...
export default function ServicesPage() {
  ...
  const services = [
    ...
    },
    {
      id: "design",
      title: "3D Design",
      bgImg: "https://www.gambody.com/storage/model-images/003439/preview_6969b3bc916a7.webp",
        ...
        <section key={service.id} className={`max-w-7xl mx-auto px-6 relative ${index === 0 ? 'mt-16' : 'mt-40'}`}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="col-span-12 lg:col-span-6 relative h-[500px] md:h-[600px] [isolation:isolate]">
              ...
              >
                <Image src={service.bgImg} alt="bg" className="w-full h-full object-cover opacity-70" fill />
              ...
              <motion.div 
                ...
                style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}
              >
                <Image src={service.focusImg} alt="focus" className="w-full h-full object-cover" fill />
